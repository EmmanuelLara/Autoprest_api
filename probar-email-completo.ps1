# Script para probar con email completo
$baseUrl = "http://localhost:3000"

Write-Host "🔐 Probando con email completo..." -ForegroundColor Yellow

# Probar con el email completo
